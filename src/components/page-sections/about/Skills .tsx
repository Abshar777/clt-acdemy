  ...
  return (
    <div className="w-full   md:px-28  px-5 md:py-30   min-h-[40vh] flex items-center justify-center md:gap-10 relative ">
      <div className="flex flex-col md:w-[60%] w-full  md:items-start items-center gap-2">
        <h2 className="mb-2 text-center md:text-5xl text-4xl   font-bold">
          {" "}
        ...
        {/* <div className="grid grid-cols-2 w-full gap-4">
          <div className="flex flex-col mt-4 items-center justify-center w-full  gap-2">
            <div className="flex items-center justify-between gap-2">
              <h2 className="text-black/60 md:text-start text-center md:text-base text-sm font-semibold">
                Account Growth
              </h2>
              <h2 className="text-primary text-2xl font-bold">30%</h2>
            </div>
          ...
          <div className="flex flex-col mt-4 items-center justify-center w-full  gap-2">
            <div className="flex items-center justify-between gap-2">
              ...
              <h2 className="text-primary text-2xl font-bold">90%</h2>
            </div>
